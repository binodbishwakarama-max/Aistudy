...
const targetPath = path.resolve(__dirname, '../src/data/dsuHubData.js');
...
export const DSU_BRANCHES = ${JSON.stringify(DSU_BRANCHES, null, 2)};
...
console.log('Successfully wrote enriched dsuHubData.js');
