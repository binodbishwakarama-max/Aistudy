        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden items-center gap-8 md:flex">
              <Link to="/dsu-hub" className="text-xs font-semibold uppercase tracking-wider text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">
                DSU Hub
              </Link>
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 mb-12 text-left">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5">
                <li><Link to="/dsu-hub" className="hover:text-[var(--text-primary)] transition-colors">DSU Hub (PYQs &amp; Notes)</Link></li>
