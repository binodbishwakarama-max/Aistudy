...
import { AlertTriangle, ArrowRight, BookOpen, Brain, Sparkles } from 'lucide-react';
...
const benefits = [
  {
    icon: Brain,
    title: 'Resume active sessions quickly',
    description: 'Jump back into flashcards, quizzes, and saved study sets without extra setup.',
  },
  {
    icon: BookOpen,
    title: 'Keep material organized',
    description: 'Your uploaded sources and generated sessions stay in one clear workspace.',
  },
];
...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError(requestError.message || 'Failed to log in.');
    }
  };
  ...
  return (
    <div className="app-shell">
      <div className="page-shell min-h-screen py-6 sm:py-8">
        <div className="grid min-h-[calc(100vh-3rem)] gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="mx-auto w-full max-w-md">
              ...
              <div className="mt-8">
                ...
                <h1 className="font-heading mt-5 text-4xl font-bold tracking-tight sm:text-5xl">
                  Sign in and continue studying.
                </h1>
                <p className="mt-4 text-base leading-8 text-[var(--text-secondary)]">
                  Open your dashboard, upload new material, or pick up an older session without the clutter.
                </p>
              </div>
          ...
          <div className="section-shell hidden p-8 lg:flex lg:flex-col lg:justify-between lg:p-10">
            <div>
              ...
              <h2 className="font-heading mt-3 text-4xl font-bold tracking-tight">
                A simpler interface makes it easier to start.
              </h2>
              <p className="mt-4 max-w-xl text-base leading-8 text-[var(--text-secondary)]">
                The goal is to let you upload, generate, and review without fighting the layout.
              </p>
            </div>
